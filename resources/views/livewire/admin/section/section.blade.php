<div>
    <div class="page-header mb-4">
        <div class="row align-items-center">
            <div class="col">
                <h2 class="page-title">Seção</h2>
            </div>
            <div class="col-auto ms-auto d-print-none">
                <div class="d-flex">
                    <a href="#" class="btn btn-green" data-bs-toggle="modal" data-bs-target="#create_section-modal">
                        ...
                        <table class="table table-vcenter card-table table-striped" id="table">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>{{ $section->created_at->format('j M Y, h:i:s')}}</td>
                                    <td>{{ $section->updated_at->format('j M Y, h:i:s')}}</td>
                                    <td>
                                        {!! ($section->status == 0 ) ? "<span class='p-2 badge bg-orange-lt'>Inativo</span>"
                                        : "<span class='p-2 badge bg-green-lt'>Ativo</span>" !!}
                                    </td>
                                    <td>
                                        <a wire:click.prevent='edit({{ $section }})'
                                            class="btn btn-outline-lime btn-sm">Editar</a>

                                        <a wire:click.prevent='delete({{ $section }})'
    ...
    @include('livewire.admin.section.section-create')
    @include('livewire.admin.section.section-edit')
    @include('livewire.admin.section.section-disable')