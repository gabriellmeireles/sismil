<div>
    <div class="page-header mb-4">
        <div class="row align-items-center">
            <div class="col">
                <h2 class="page-title">Tipo de Usuário</h2>
            </div>
            <div class="col-auto ms-auto d-print-none">
                <div class="d-flex">
                    <a href="#" class="btn btn-green" data-bs-toggle="modal" data-bs-target="#create_candidate_type-modal">
                    ...
                    <div class="table-responsive">
                        <table class="table table-vcenter card-table table-striped" id="table">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td class="text-muted">{{ $candidateType->id }}</td>
                                    <td>{{ $candidateType->name }}</td>
                                    <td>{{ $candidateType->updated_at->format('j M Y, h:i:s')}}</td>
                                    <td>
                                        {!! ($candidateType->status == 0 ) ? "<span class='p-2 badge bg-orange-lt'>Inativo</span>"
