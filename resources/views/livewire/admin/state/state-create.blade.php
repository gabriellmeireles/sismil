{{-- CREATE MODAL --}}
<div wire:ignore.self class="modal modal-blur fade" id="create_state-modal" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog modal-lg modal-dialog-centered" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">Estado | Cadastrar</h5>
