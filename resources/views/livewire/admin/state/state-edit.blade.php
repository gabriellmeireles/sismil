 {{-- EDIT MODAL --}}
 <div wire:ignore.self class="modal modal-blur fade" id="edit_state-modal" tabindex="-1" role="dialog" aria-hidden="true">
                    ...
                    <div class="row">
                        <div class="col-lg-8">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control text-uppercase @error('short_name'){{ 'is-invalid' }}@enderror" maxlength="2" placeholder="Sigla" wire:model='short_name'>
