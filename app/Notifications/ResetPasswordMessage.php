...
class ResetPasswordMessage extends Notification
{
    /**
    ...
    protected function buildMailMessage($url)
    {
        return (new MailMessage)
            ->subject(Lang::get('Notificação de Redefinição Senha'))
            ...
            ->line(Lang::get('Se você não solicitou uma redefinição de senha, desconsidere esse email!'));
    }
